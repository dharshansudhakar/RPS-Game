...
<template>
	<div class="bg-gray-700 text-white text-center min-h-screen flex flex-col">
		...
		<main class="container mx-auto p-6 flex-1">
			<div v-if="choice === null" class="flex items-center justify-center -mx-6">
				...
				<button @click="play('rock')"
					...
					<img src="./assets/RockIcon.jpg" alt="Rock" class="w-full" />
				</button>
				...
				<button @click="play('paper')"
					...
					<img src="./assets/PaperIcon.png" alt="Paper" />
				</button>
				...
				<button @click="play('scissors')"
					...
					<img src="./assets/ScissorIcon.png" alt="Scissors" />
				</button>
		...
		<footer class="container mx-auto p-6">
			<a href="dharshanans54@gmail.com">Rock Paper Scissors Game Vectors by
				Dharshana</a>
		</footer>
	</div>
</template>
